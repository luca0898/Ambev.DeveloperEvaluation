...
namespace Ambev.DeveloperEvaluation.ORM.Migrations
{
    ...
    [Migration("20250305143529_AddUserDeletedColumn")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ambev.DeveloperEvaluation.Domain.Models.Branch", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Ambev.DeveloperEvaluation.Domain.Models.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Ambev.DeveloperEvaluation.Domain.Models.Customer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Ambev.DeveloperEvaluation.Domain.Models.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Ambev.DeveloperEvaluation.Domain.Models.ProductRating", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Ambev.DeveloperEvaluation.Domain.Models.CartDomain.Entities.CartItem", b =>
                {
                    ...
                    b.HasOne("Ambev.DeveloperEvaluation.Domain.Models.Product", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Ambev.DeveloperEvaluation.Domain.Models.Product", b =>
                {
                    b.HasOne("Ambev.DeveloperEvaluation.Domain.Models.Category", "Category")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("Ambev.DeveloperEvaluation.Domain.Models.ProductRating", b =>
                {
                    b.HasOne("Ambev.DeveloperEvaluation.Domain.Models.Product", "Product")
                        .WithOne("Rating")
                        .HasForeignKey("Ambev.DeveloperEvaluation.Domain.Models.ProductRating", "ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Ambev.DeveloperEvaluation.Domain.Models.SaleDomain.Entities.Sale", b =>
                {
                    b.HasOne("Ambev.DeveloperEvaluation.Domain.Models.Branch", null)
                        .WithMany()
                        .HasForeignKey("BranchId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Ambev.DeveloperEvaluation.Domain.Models.Customer", null)
                        .WithMany()
